...
import { TestStepField } from '../store/useCustomizationStore';

interface AddTestStepTemplateModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function AddTestStepTemplateModal({ isOpen, onClose, onAdd }: AddTestStepTemplateModalProps) {
    ...
    <Modal 
      ...
      footer={
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" form="add-test-step-template-form" disabled={!name}>
            Add Template
          </Button>
        </div>
      }
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100vh-200px)] overflow-hidden">
        ...
        <div className="flex flex-col h-full overflow-y-auto pr-2 custom-scrollbar">
          <form id="add-test-step-template-form" onSubmit={handleSubmit} className="space-y-6">
